...
Даже если бы функция от 8 параметров имела для каждого значения всего по 4 дискретных значение, 
...
По итогу мы получаем 3 различных результата, достич которых можно разными путями. 
...
По адресу https://wolfr.am/NtqA4a7O располагается API сервис с тем же функционалом. 
