...
(*Задача 2 (опциональная, второй уровень сложности)*)

(*Запрограммируй описанную логику на любом языке программирования. Чтобы проверить себя, применяй тесты из предыдущего уровня.*)
...
$creditCalculatorAPI = 
	CloudDeploy[
		...
		"Deploy/Yandex.Praktikum.TestTask/CreditCalculator/API/" <> Hash[CreditCalculator, "SHA", "HexString"], 
		Permissions -> "Public"
	]; 
...
$creditCalculatorForm = 
	CloudDeploy[
		...
		"Deploy/Yandex.Praktikum/CreditCalculator.TestTask/Form/" <> Hash[CreditCalculator, "SHA", "HexString"], 
		Permissions -> "Public"
	]; 
